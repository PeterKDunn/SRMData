...
#'   \item{Gender}{The gender of the patient; one of `1` (male) or `2` (female)}
...
#'   \item{SAOS}{The SAOS score; one of `Severe`, `Moderate` or `Low`}
#' }
#' @source de Carvalho, Anderson Albuquerque, Fabio Ferreira Amorim, Levy Aniceto Santana, Karlo Jozefo Quadros de Almeida, Alfredo Nicodemos Cruz Santana, and Francisco de Assis Rocha Neves. 2020.
#' STOP-Bang Questionnaire Should Be Used in All Adults with Down Syndrome to Screen for Moderate to Severe Obstructive Sleep Apnea.” PloS ONE 15 (5): e0232596.
