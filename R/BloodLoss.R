...
#' }
#' @note The known mean values are, resspectively, 64.31, 19.24, 64.97 and 19.40 mIU/ml.
#' @source Feng, Yang-chun and Huang, Yan-chun and Ma, Xiu-min. 2017.
#' The application of {S}tudent's $t$-test in internal quality control of clinical laboratory.
#' \emph{Frontiers in Laboratory Medicine} \bold{1} (3): 125--128.
#' 
#' @usage data(BloodLoss)
