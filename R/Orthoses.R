...
#' 
#' @source 
#' Swinnen, Eva, Jean-Pierre Baeyens, Benjamin Van Mulders, Julian Verspecht, 
#' and Marc Degelaen (2017). 
#' "The Influence of the Use of Ankle-Foot Orthoses on Thorax, Spine, 
#' and Pelvis Kinematics During Walking in Children with Cerebral Palsy".
