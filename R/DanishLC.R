...
#' \describe{
#'   \item{Cases}{The number of lung cancer cases for the given age group
#'         and city}
#'   \item{Pop}{The population for the given age group and city}
#'   \item{Age}{The age group; one of \code{40-54}, \code{55-59}, 
#'              \code{60-64}, \code{65-69}, \code{70-74} or \code{>74}}
#'   \item{City}{The city; one of \code{Fredericia}, \code{Horsens},
#'         \code{Kolding} or \code{Vejle}}
#' }
#' 
#' @references 
#' E. B. Andersen (1977).
