...
#' \describe{
#'   \item{AgeGroup}{The age group of the person; one of \code{1} (18 to 24), 
#'         \code{2} (25 to 34), \code{3} (25 to 50) or \code{4} (51 to 65)}
...
#' 
#' @details 
#' The data provide the number of people correctly identifying 
