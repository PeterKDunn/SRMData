...
#' @keywords datasets
#'
#' @format A data frame with 403 rows (one per person) and 4 columns; many values are missing
#' \describe{
#'   \item{SBPfirst}{the systolic blood pressure from the first visit, in mm Hg}
#'   \item{DBPfirst}{the diasystolic blood pressure from the first visit, in mm Hg}
