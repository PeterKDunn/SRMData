...
#' \describe{
#'   \item{Brand}{One of `Energizer` or `Uktracell` (ALDI home brand))}
...
#' }
#' @source Dunn, Peter K. 2013. Comparing the Lifetimes of Two Brands of Batteries. Journal of Statistical Education, 21 (1).
