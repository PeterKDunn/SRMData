...
#' }
#' @source Steele, S. 1997. Babies by the Dozen for Christmas: 24-Hour Baby Boom. \emph{The Sunday Mail}, 7.
#' 
#' Dunn, Peter K. 1999. A Simple Dataset for Demonstrating Common Distributions. 
