...
#'   \item{Indus}{whether the country is considered an industrialized country; a factor with levels \code{Ind} (industrialized) or \code{NonInd} (not industrialized)}
...
#' }
#' @source Woodward, M., and A. R. P.Walker. 1994. Sugar Consumption and Dental Caries: Evidence from 90 Countries. 
#' \emph{British Dental Journal} \bold{176}: 297--302
#' 
#' M. Woodward (2004) \emph{Epidemiology: Study Design and Data Analysis}, second edition. Chapman and Hall.
#' 
#' @usage data(Dental)
