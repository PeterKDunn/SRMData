...
#'   \item{Indus}{whether the country is considered an industrialized country; a factor with levels `Ind` (industrialized) or `NonInd` (not industrialized)}
...
#' }
#' @source Woodward, M., and A. R. P.Walker. 1994. Sugar Consumption and Dental Caries: Evidence from 90 Countries. British Dental Journal 176: 297--302
