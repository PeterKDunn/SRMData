...
#' \describe{
#'   \item{AgeGroup}{One of \code{1} (18 to 19), \code{2} (20 to 21) or 
#'         \code{3} (Older than 22)}
#'   \item{Compliance}{One of \code{1} (complied with isolation order) 
#'         or \code{2} (did not comply}
