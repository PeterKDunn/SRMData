...
#' @keywords datasets
#'
#' @format A data frame with 8 rows (each combination) and 4 columns:
#' \describe{
#'   \item{Counts}{The number of people with the combination of the other variables}
#'   \item{Group}{One of \code{Small} or \code{Large}, the kidney stone size}
#'   \item{Method}{The method used; one of \code{Method A} or \code{Method B}}
#'   \item{Outcome}{The outcome of the procedure; one of \code{Success} or \code{Failure}}
#' }
#' @source Charig, C. R.,D. R. Webb, S. R.Payne, and J. E. A. Wickham. 1986.
