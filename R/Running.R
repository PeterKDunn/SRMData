...
#'         Garmin Heart Rate Monitor-Pro (HRM), in cm}
#'   \item{NOVA}{The VO as measured by the  the INCUS NOVA device, in cm}
#'   \item{RDP}{The VO as measured by the Garmin Running Dynamics Pod (RDP), 
#'         in cm}
#'   \item{Footpod}{The VO as measured by the Stryd Running Power Meter 
#'         Footpod (Footpod), in cm}
