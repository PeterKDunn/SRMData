...
#'   \item{edu}{Level of education;
#'         one of \code{primary}, \code{secondary}, \code{postLeaving}, 
#'         \code{complete3rd}}
#'   \item{m_card}{whether the person has a medical card; 
#'         one of \code{yes} or \code{no}}
#'   \item{smoke}{smoking status; 
#'         one of \code{daily}, \code{occasionally} or \code{not at all}}
#'   \item{drink}{whether the person drinks alcohol weekly; 
#'         one of \code{yes} or \code{no}}
#'   \item{exercise}{The number of days per week the person walks or 
#'         exercise for 30 minutes or more}
#'   \item{diet}{whether the person thinks they have a healthy diet; 
#'         one of \code{yes}, \code{no} or \code{dont know}}
...
#'   \item{bmi_perception}{the person perception of the BMI; 
#'         one of \code{normalweight}, \code{overweight} or \code{obese}}
#' }
#' 
#' @details 
...
#' The association between BMI self-selection, self-reported BMI 
#' and objectively measured BMI. 
