#' Wheelchair tennis
#'
#' The push-time for wheelchair tennis players, 
#' with and without holding a racquet.
#' 
#' 
#' @docType data
#' 
#' @keywords datasets
#'
#' @format A data frame with 13 rows (each plants) and 3 columns:
#' \describe{
#'   \item{Person}{The person}
#'   \item{PTwith}{The pushtime, when holding a racquet; in seconds}
